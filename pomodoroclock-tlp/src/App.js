  ...
  return  (
    <div className="app-container">
      ...
      <div className="footer-container">
        <div >
          <p className="footer"> React Pomodoro Clock App created by &nbsp;{" "}<a href="https://github.com/tlanettepollard">{" "}<span> T.Lanette Pollard </span></a> &nbsp;FreeCodeCamp Front End Libraries Project </p>
        </div>
      </div>
